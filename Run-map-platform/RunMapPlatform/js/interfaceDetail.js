...
var obj = GetRequest()
var interfaceUrl = "./RMap_Interface/RMap." + obj.name + "." + obj.child + ".html";
if(obj.name == "helloWorld" || obj.name === undefined) {
	interfaceUrl = "./RMap_Interface/RMap.html";
}
var exampleUrl = "./RMap_Examples/" + obj.child + ".html";
if(obj.name == "helloWorld" || obj.name === undefined) {
	exampleUrl = "./RMap_Examples/helloWorld.html";
}
...
$(".hov").on("click", function() {
	if($(this).attr("id")=="index_li_id"){
		...
		interfaceUrl = "./RMap_Interface/RMap." + name + "." + child + ".html";
		if(name == "helloWorld" || name === undefined) {
			interfaceUrl = "./RMap_Interface/RMap.html";
		}
		exampleUrl = "./RMap_Examples/" + child + ".html";
		if(name == "helloWorld" || name === undefined) {
			exampleUrl = "./RMap_Examples/helloWorld.html";
		}
