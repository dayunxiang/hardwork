    ...
    $('#jqTable').DataTable({
        ...
        columnDefs: [{
            ...
            render: function(data, type, row, meta) {
                return '<img src="./img/Slice 2.png" title="结束任务" alt="" class="tooltip1 jqend  fl-r" />' +
                    '<img src="./img/ico-push.png" alt="" title="分配任务" class="tooltip1 jqrwfp fl-r"  style="display:' + row.isFp + '"/>' +
                    '<img src="./img/ico-detail.png" alt="" title="详情" class="tooltip1 jqDetail  fl-r"  />';
            }
        }],
        searching: true,
        ordering: false,
