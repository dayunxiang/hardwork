...
public class ConstantUtil {
	 ...
	 * 设备类别集
	 */
	public static final DynaBean equipmentTypeBean;
	static{
		equipmentTypeBean = DynaBeanPluginsUtil.invoke();
		equipmentTypeBean.set("1", "A");
		equipmentTypeBean.set("2", "A");
		equipmentTypeBean.set("3", "A");
	}
	 ...
	 * 设备状态集
	 */
	public static final DynaBean equipmentStateBean;
	static{
		equipmentStateBean = DynaBeanPluginsUtil.invoke();
		equipmentStateBean.set("1", "在用");
		equipmentStateBean.set("2", "闲置可用");
		equipmentStateBean.set("3", "闲置故障");
		equipmentStateBean.set("4", "故障");
		equipmentStateBean.set("5", "报废");
	}
